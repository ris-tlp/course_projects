...
<body style="background-color: #d8dbe2;">
    ...
    <section class="d-flex">
        ...
        <section id="main-area">
            ...
            <form id="assessmentForm">
                <div class="float-left" id="top-leftDiv" style="max-width: 50%;width: 50%;height: auto;">
                    <label class="d-inline-block" style="margin-bottom: 7%;width: 100%;max-width: 100%;"> Name of Assessment
                        <input class="d-flex float-right" type="text" style="max-width: 60%;margin-right: 20px;width: 60%;min-width: 10%;height: auto;" placeholder="Example: Physics 101" id="assessmentName" required>
                    </label>

                    <label style="margin-bottom: 7%;width: 100%;max-width: 100%;">Date of Assessment
                        <input class="d-flex float-right" type="datetime-local" style="width: 60%;min-width: 10%;max-width: 60%;margin-right: 20px;" id="assessmentDate" required>
                    </label>

                    <label class="text-break" style="width: 100%;max-width: 100%;min-width: 10%;">Duration of Assessment
                        <input class="d-flex float-right" type="number" style="max-width: 60%;width: 60%;min-width: 30%;margin-right: 20px;" id="assessmentDuration" placeholder="in minutes" required>
                    </label>

                    <label class="text-break" style="width: 100%;max-width: 100%;min-width: 10%;">Syllabus
                        <input class="d-flex float-right" type="text" style="max-width: 60%;width: 60%;min-width: 30%;margin-right: 20px;" id="assessmentSyllabus" placeholder="Example: 10.1 to 10.6" required>
                    </label>

                    <label class="text-break" style="width: 100%;max-width: 100%;min-width: 10%;">Rules
                        <textarea class="d-flex float-right" type="text" style="max-width: 60%;width: 60%;min-width: 30%;margin-right: 20px; resize: none;" id="assessmentRules" placeholder="No referring to notes" required> </textarea>
                    </label>

            </form>

            <div class="form-check d-block float-left" style="margin-right: 0;margin-bottom: 5%;width: 100%;max-width: 100%;"><input class="form-check-input" type="checkbox" id="formCheck-1" required name="isRandom" style="display: none;"><label class="form-check-label d-inline-block" for="formCheck-1" style="display: none;"></label></div>
            </div>
            <div class="float-right" id="top-rightDiv" style="width: 40%;max-width: 40%;height: auto;min-width: 20%;">

                <div class="form-check d-block float-left" style="margin-right: 0;width: 100%;max-width: 100%;"></div>
            </div>
            <div class="d-block" id="bigAreaDiv" style="height: auto;max-width: 100%;"><label style="width: 100%;max-width: 100%;margin-top: 20px;">List of questions:</label>
                <div class="table-responsive" style="width: 80%;min-width: 40%;max-width: 80%;margin-left: 5px; height: 250px; overflow-y: scroll;">
            ...
            <div class="m-auto" id="bottomDiv" style="margin-right: 30%;color: rgb(0,0,0);width: 70%;min-width: 40%;max-width: 100%;height: auto;">
                <button class="btn btn-primary" id="question-button" type="button" style="min-width: auto;max-width: 30%;width: 30%;margin-right: 8%;">
                    <a id="button-link" style="text-decoration: none; display: block; color: black;">
                        Add questions
                    </a>
                </button>
                ...
                <button class="btn btn-primary float-right" type="button" style="width: 30%;min-width: auto;max-width: 30%;margin-left: 10%;" id="createTest">Create test</button>
            </div>
        </section>
    </section>
    ...
    <script src="../assets/js/questionAddHandler.js "></script>

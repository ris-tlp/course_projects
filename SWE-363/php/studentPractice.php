...
$q = $link->prepare("SELECT *, 
                        firstName AS dr_firstName, 
                        lastName AS dr_lastName 
                        FROM `practice_test` 
                        INNER JOIN `instructor`
                        ON `practice_test`.instructor_ID = `instructor`.id ;");
$q->execute();
$result = $q->get_result();
            ...
            <div class="table-responsive border-dark">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><a href="detailedPractice.php?id=<?php echo $row["test_ID"] . "&num=" . $row["num_of_questions"]; ?>">Practice questions for <?php echo $row["test_name"]; ?></a></td>
